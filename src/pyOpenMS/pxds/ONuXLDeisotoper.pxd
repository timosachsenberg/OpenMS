...
cdef extern from "<OpenMS/ANALYSIS/XLMS/ONuXLDeisotoper.h>" namespace "OpenMS":
    cdef cppclass Deisotoper:
        Deisotoper() nogil except +
        Deisotoper(Deisotoper) nogil except + # wrap-ignore

# COMMENT: wrap static methods
cdef extern from "<OpenMS/ANALYSIS/XLMS/ONuXLDeisotoper.h>" namespace "OpenMS::Deisotoper":
