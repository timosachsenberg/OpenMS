...
cdef extern from "<OpenMS/ANALYSIS/XLMS/PScore.h>" namespace "OpenMS":
    ...
    cdef cppclass PScore "OpenMS::PScore":
        ...
        double computePScore(double fragment_mass_tolerance, bool fragment_mass_tolerance_unit_ppm, libcpp_map[ size_t, MSSpectrum ] & peak_level_spectra, libcpp_vector[ MSSpectrum ] & theo_spectra, double mz_window) nogil except +
