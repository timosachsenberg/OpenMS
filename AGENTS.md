...
- **CMAKE_PREFIX_PATH separators**: When passing via `-D` option, use semicolons (`;`) as list separators. Environment variables use OS-specific separators (`:` on Unix, `;` on Windows).
